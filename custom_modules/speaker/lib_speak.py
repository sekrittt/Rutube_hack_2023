...
from .lib_helper import disable_logging, timeit
...
class SpeakerBase:
    ...
    def __init__(
        ...
        self.language: Literal["ru", "en"] = language
...
class Speaker(SpeakerBase):
    ...
    def to_mp3(
        ...
        list_path_to_audio: list[pathlib.Path] = list(
            self._chunks_synthes(sl_text, audio_dir, _speed, sample_rate) # type: ignore
        )
        ###
        #
